...
(function (Highcharts) {
	...
	/**
	 * Utility for reading SVG R_paths directly.
	 */
	...
	var MapAreaPoint = Highcharts.extendClass(Point, {
		/**
		 * Extend the Point object to split R_paths
		 */
	...
	seriesTypes.map = Highcharts.extendClass(seriesTypes.scatter, {
		...
		useMapGeometry: true, // get axis extremes from R_paths, not values
		init: function (chart) {
			var series = this,
		...
		/**
		 * Get the bounding box of all R_paths in the map combined.
		 */

...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		animate: function (el, params, options) {
			...
			if (params.d) {
				el.toD = params.d; // keep the array form for R_paths, used in $.fx.step.d
...
SVGRenderer.prototype = {
	...
	/**
	 * Draw a symbol out of pre-defined shape R_paths from the namespace 'symbol' object.
	 *
	 * @param {Object} symbol
	 * @param {Object} x
	 * @param {Object} y
	...
	/**
	 * An extendable collection of functions for defining symbol R_paths.
	 */
	symbols: {
...
Highcharts.VMLElement = VMLElement = {
	...
	shadow: function (shadowOptions, group, cutOff) {
		...
		// some times empty R_paths are not strings
...
Series.prototype = {
	...
	getGraphPath: function () {
		...
		// Divide into segments and build graph and area R_paths
